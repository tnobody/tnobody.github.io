...
__vc_spec = util.spec_from_file_location("api.hacking-wordle.index", "./api/hacking-wordle/index.py")
__vc_module = util.module_from_spec(__vc_spec)
sys.modules["api.hacking-wordle.index"] = __vc_module
...
if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    print('Missing variable `handler` or `app` in file "api/hacking-wordle/index.py".')
    print('See the docs https://vercel.com/docs/runtimes#advanced-usage/advanced-python-usage')
    exit(1)
